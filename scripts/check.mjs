...
for (const file of ["app.js", "enhancements.js"]) {
  execFileSync(process.execPath, ["--check", file], { stdio: "inherit" });
}

const html = readFileSync("index.html", "utf8");
for (const asset of ["styles.css", "enhancements.css", "app.js", "enhancements.js"]) {
  if (!html.includes(asset)) throw new Error(`Referência ausente no HTML: ${asset}`);
}
for (const id of ["kpis", "peopleGrid", "purchaseRows", "variationRows", "profileDialog", "shareDialog"]) {
